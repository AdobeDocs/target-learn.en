...
title: Code Page
seo-title: Code Page
description: Provide a brief description of what the code illustrated and required context. This should be brief and provides a highlevel outline of what is covered in the video. This can be used to drive the SEO description (in Page Properties) as well.
seo-description: Provide a brief description of what the code illustrated and required context. This should be brief and provides a highlevel outline of what is covered in the video. This can be used to drive the SEO description (in Page Properties) as well.
page-status-flag: never-activated
uuid: 46ca0c71-5b80-4ad2-a4d7-d26d7c995a1c
discoiquuid: efa9601b-eba7-46c8-b64f-604f416718e0
...
Include any callouts or set context that is too specific for the description.
...
[ ](https://github.com/Adobe-Marketing-Cloud/aem-core-wcm-components) Provide any highlevel guidance around the overall sample that is too technical to be put in the description.
