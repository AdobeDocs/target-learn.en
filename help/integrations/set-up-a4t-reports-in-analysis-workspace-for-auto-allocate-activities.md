...
| --- | --- | --- |
|Maximize conversions for an [!DNL Analytics] metric|<ul><li>[!UICONTROL Confidence] metrics should be removed.</li><li>Remove all [!UICONTROL Lift] metrics.</li><li>Uncheck the percentage presentation from the [!UICONTROL Conversion Rate] column to avoid confusion. See [Overall guidance for A4T](#guidance) below.</li></ul>|<ul><li>Remove [!UICONTROL Confidence] metrics.</li><li>Remove all [!UICONTROL Lift] metrics.</li><li>Create a segment to filter visitors with a positive metric value who viewed the activity that was analyzed. See [Create a segment](#segment) below.</li><li>Replace the auto-populated [!UICONTROL Conversion Rate] metric so that is the division between [!UICONTROL Unique visitors] with a positive metric value and unique visitors. See [Update the Conversion Rate metric](#update-conversion-metric) below.</li><li>Uncheck the percentage presentation from the [!UICONTROL Conversion Rate] column to avoid confusion. See [Overall guidance for A4T](#guidance) below.</li><li>Ensure that the date and time ranges align with the values you see in the [!DNL Target] report. See [Overall guidance for A4T](#guidance) below.</li></ul>|
